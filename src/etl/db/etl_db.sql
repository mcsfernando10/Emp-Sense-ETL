...
CREATE TABLE IF NOT EXISTS `employeesIT_Predict_Feature_Cont` (
  `Employee_ID` varchar(100) DEFAULT NULL,
  `Employee_Name` varchar(1000) DEFAULT NULL,
  `Age` float(8,2) DEFAULT NULL,
  `Gender` float(8,2) DEFAULT NULL,
  `Marital_Status` float(8,2) DEFAULT NULL,
  `Having_Degree` float(8,2) DEFAULT NULL,
  `Job_Role` float(8,2) DEFAULT NULL,
  `Department` float(8,2) DEFAULT NULL,
  `WorkFrom` float(8,2) DEFAULT NULL,
  `WorkTo` float(8,2) DEFAULT NULL,
  `Tenure` float(8,2) DEFAULT NULL,
  `Salary` float(8,2) DEFAULT NULL,
  `Bonus` float(8,2) DEFAULT NULL,
  `Claims` float(8,2) DEFAULT NULL,
  `Worked_Project` float(8,2) DEFAULT NULL,
  `No_of_Leaves` float(8,2) DEFAULT NULL,
  `Distance` float(8,2) DEFAULT NULL,
  `No_of_Parents` float(8,2) DEFAULT NULL,
  `No_of_Children` float(8,2) DEFAULT NULL,
  `No_of_Complaints` float(8,2) DEFAULT NULL,
  `Bias` float(8,2) DEFAULT NULL,
  `Prediction_Probability` float(8,2) DEFAULT NULL,
  `Max_Feature` varchar(1000) DEFAULT NULL
);

CREATE TABLE IF NOT EXISTS `feature_importance_churn` (
  `Feature` varchar(1000) DEFAULT NULL,
  `Importance` float(8,2) DEFAULT NULL
); 
