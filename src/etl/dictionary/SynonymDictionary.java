...
public class SynonymDictionary {
    ...
    public SynonymDictionary() {
        ...
        String[] synonymsForDepartment = new String[]{"dept","department"};
        String[] synonymsForWorkForm = new String[]{"work from","started date","work_from","from"};
        String[] synonymsForWorkTo = new String[]{"work to","resigned date","work_to","to"};
        ...
        String[] synonymsForNoOfParents = new String[]{"noofparents","nonschoolgoingdep"};
        ...
        words.put(StringConstants.DEPARTMENT, synonymsForDepartment);
        words.put(StringConstants.WORK_FROM, synonymsForWorkForm);
