...
n_estimators, max_features, leaf = tune_params.tune_rf(X,y)
...
pred_prob, clf = cv_predict(X, y, RF, n_estimators=n_estimators, max_features=max_features, min_samples_leaf=leaf)
