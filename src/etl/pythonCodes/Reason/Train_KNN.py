...
y_pred_reason_knn, y_test_knn, clf = reason_predict(X_reason,y_reason, KNN)

joblib.dump(clf, 'D:\SLIIT\ITIndustry\Reason\knn_model_reason.pkl', compress=1)

emp_id = df_mysql['Employee_ID']
id = emp_id.tolist()

y_pred_reason_knn.tolist()
